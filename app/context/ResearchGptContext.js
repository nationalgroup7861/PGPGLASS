...
const ResearchGptContext = createContext();
ResearchGptProvider.propTypes = {
  children: PropTypes.node,
};
function ResearchGptProvider({ children }) {
  ...
  async function GetPermissionandkey() {
    ...
    try {
      ...
      if (response) {
        ...
        setChatGptKey(data?.perplexity_key)
...
export { ResearchGptContext, ResearchGptProvider };
