...
const GlassGptContext = createContext();
GlassGptProvider.propTypes = {
  children: PropTypes.node,
};
function GlassGptProvider({ children }) {
...
export { GlassGptContext, GlassGptProvider };
