...
const AlfieGptContext = createContext();
AlfieGptProvider.propTypes = {
  children: PropTypes.node,
};
function AlfieGptProvider({ children }) {
...
export { AlfieGptContext, AlfieGptProvider };
